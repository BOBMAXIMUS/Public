      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.all(5.0),
            child: Image(
              image: AssetImage("assets/images/book_now.jpg"),
              fit: BoxFit.contain,
            ),
          ),
          Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.all(5.0),
            child: Image(
              image: AssetImage("assets/images/PlanAClassForLater.jpg"),
              fit: BoxFit.contain,
            ),
          ),
          Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.all(5.0),
            child: Image(
              image: AssetImage("assets/images/MathsInMotion.jpg"),
              fit: BoxFit.contain,
            ),
          ),
          Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.all(5.0),
            child: Image(
              image: AssetImage("assets/images/request_correction.jpg"),
              fit: BoxFit.contain,
            ),
          ),
          Container(
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            margin: EdgeInsets.all(5.0),
            child: Image(
              image: AssetImage("assets/images/dificulty_bar.jpg"),
              fit: BoxFit.fitWidth,
            ),
          ),
        ],
