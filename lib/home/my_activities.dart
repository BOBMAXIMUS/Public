    ...
    child: Row(
      children: [
        Container(
          ...
          child: Image(
              image: AssetImage("assets/images/EditInfo.jpg"),
              fit: BoxFit.cover),
        ),
        Container(
          //  color: Colors.blue,
    ...
    Widget rowRow1 = Row(
      children: [
        cardTileIcon("Terminale S", "Subtitle text",
            "assets/images/Profile.jpg", Colors.black),
    ...
    Widget rowRow2 = Row(
      children: [
        cardTileIcon("8 cours particuliers", "Subtitle text",
            "assets/images/MCNStats.jpg", Colors.black),
    ...
    Container example2 = Container(
      ...
      decoration: BoxDecoration(
        ...
        image: DecorationImage(
          image: AssetImage("assets/images/stats_board.png"),
          fit: BoxFit.fill,
        ),
      ),
      child: Column(
