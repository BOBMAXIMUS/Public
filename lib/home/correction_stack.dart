  ...
  Widget build(BuildContext context) {
    ...
    Widget allBanner = Container(
      ...
      child: Wrap(
        ...
        children: [
          myContainer("assets/images/uploadFileBlack.jpg", "View List"),
          arrow,
          myContainer("assets/images/checkOut.jpg", "Estimate"),
          arrow,
          myContainer("assets/images/resultBlack.jpg", "Correct"),
          arrow,
          myContainer("assets/images/checkOut.jpg", "Earnings")
        ],
      ),
    );
